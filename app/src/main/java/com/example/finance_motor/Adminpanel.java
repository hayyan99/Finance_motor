...
//    new added start
private static final String dealer_API_URL = "http://192.168.68.120/MVFP/dealer.php";
...
//        new added start
        tableLayout2 = findViewById(R.id.tableLayout);

        // Fetch data from the API in a background thread
        new FetchDataTask().execute(dealer_API_URL);
